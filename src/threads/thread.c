                    ...
                    thread_func *function, void *aux)
{
  ...
  /* Verifica prioritatea thread-ului si cedeaza prioritate in cazul necesar */
...
void thread_set_priority(int new_priority)
{
  ...
  /* Adevarat in cazul exista in lista si trebuie verificata prioritatea. */
  bool check_priority = false;

  /* Urmatorul thread din lista dupa prioritate (lista este sortata). */
...
{
  /* returneaza cea mai mare valoare de prioritate a thread-urilor din waiting list si prioritatea originala a thread-ului */
...
/* O functie de comparare a doua thread-uri care sorteaza dupa prioritate care insereaza un thread in list_insert_ordered */
...
/* O functie de comparare a doua thread-uri care sorteaza dupa prioritate list_empty */
...
/* Se verifica daca tread-ul inserat are o prioritate mai mare decat thread-ul curent. */
